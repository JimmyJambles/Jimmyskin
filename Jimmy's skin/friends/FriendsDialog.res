"Friends/FriendsDialog.res"
{
		...
		Menu
    {
 	...
 	layout
 	{
		...
		place { control="FriendsDialogSheet" start=friends_search_icon margin-left=-3 dir=down width=max height=max spacing=3 margin-top=2 margin-bottom=20 margin-right=0 }	
		place {
